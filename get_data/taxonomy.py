...
taxonomy = {
    ...
    _LANGUAGE + "response_language": {
        "args": {
            "language": ['bn', 'kn', 'pa', 'mr', 'fa', 'vi', 'ko', 'sw', 'ru', 'hi', 'bg', 'pt', 'te', 'it', 'ar', 'ta',
                         'fi', 'ne', 'ur', 'th', 'gu', 'de']
        },
        "description": [
    ...
    _STARTEND + "end_checker": {
        "args": {
            "end_phrase": ['Is there anything else I can help with?', 'Hope you agree with me.',
                           'Let me know if you have additional questions.', 'your love, and thanks.',
    ...
    _SCONTENT+"open_ended":{
        "args": {},
        "description": []
    },
    _SITUATION+"suggestion":{
        "args": {},
        "description": []
    },
    _SITUATION+"role_play":{
        "args": {},
        "description": []
    },
    _SITUATION+"story_generation":{
        "args": {},
        "description": []
    },
    _STYLE+"open_ended":{
